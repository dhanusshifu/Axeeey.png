...
def lucid_connect():
    ...
    print(f"{GRAY}├───────────────────────────────────────────────┤")
    print(f"{GREEN}│ {GREEN}• {WHITE}Website      : {GRAY}https:// soon ~              │")
    print(f"{GREEN}│ {GREEN}• {WHITE}Instagram    : {GRAY}@ftfarsan                    │")
    print(f"{GREEN}│ {GREEN}• {WHITE}YouTube      : {GRAY}@axeeeh                      │")
    print(f"{GREEN}│ {GREEN}• {WHITE}Telegram     : {GRAY}@soon         (Channel)      │")
    print(f"{GREEN}│ {GREEN}• {WHITE}Support Bot  : {GRAY} soon                        │")
    print(f"{GREEN}│ {GREEN}• {WHITE}GitHub       : {GRAY}github.com/dhanusshifu       │")
    print(f"{GRAY}└───────────────────────────────────────────────┘")
    print()
    input(f"{WHITE}Press {GREEN}Enter{WHITE} to return to main menu...")
...
def lucid_help():
    ...
    print(f"{GREEN}│ {WHITE}  → {QUOTE_BLUE}https://github.com/dhanusshifu                   {GRAY}│")
    print(f"{GRAY}└──────────────────────────────────────────────────────────────┘")
    print()
    print()
    print(f"{GRAY}┌──────────────────────────────────────────────────────────────┐")
